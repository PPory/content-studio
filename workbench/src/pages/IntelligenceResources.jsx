...
const kinds={"hot-summary":"热点摘要",post:"讨论帖",article:"原文",comment:"评论",external_digest:"资讯摘要",podcast_transcript:"播客转录",tweet:"动态"};
export function IntelligenceResources({onGo}) {
 ...
 return <div className="intel-workspace intelligence-v2 intel-resources-page"><IntelligenceNav current="intel-resources" onGo={onGo}/><IntelligenceHeader title="原始资料" desc="查找保留的原文、出处和已保存的热点摘要。摘要需核对原文。"/>
