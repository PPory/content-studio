 ...
 */
export const PROJECT_STAGES = ["策划中", "生成中", "写作中", "待诊断", "待发布", "待复盘", "已完成", "已搁置", "需处理"];
...
export const PROJECT_STAGE_META = {
  ...
  待诊断: { index: "04", label: "诊断", hint: "检查结构、证据和发布风险" },
  待发布: { index: "05", label: "发布", hint: "排版、发布并记录链接" },
  待复盘: { index: "06", label: "复盘", hint: "补齐数据，留下下一篇的判断" },
  已完成: { index: "07", label: "完成", hint: "已经发布并留下复盘结论" },
  已搁置: { index: "—", label: "搁置", hint: "暂不推进，但保留全部内容" },
  需处理: { index: "!", label: "需处理", hint: "关系或状态有歧义，需要你决定" },
};

const ACTION_PRIORITY = new Map(["需处理", "待发布", "待诊断", "写作中", "待复盘", "策划中"].map((stage, i) => [stage, i]));
