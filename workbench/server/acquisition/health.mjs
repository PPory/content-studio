export function errorStatus(error) {
 ...
 if(error?.blocked||[401,403].includes(error?.status)||/OAuth|approval|批准|HTTP 40[13]/i.test(message))return 'AUTH_BLOCKED';
...
export function successStatus(stats,coverage={}) {
 ...
 return stats.new||stats.updated?'OK':'NO_NEW_ITEMS';
}
