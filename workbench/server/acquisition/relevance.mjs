...
export const REVIEW_RULE_VERSION = 'ai-reading-1.0';
...
export function classifyAiRelevance(source = {}) {
 ...
 if (hit && substance.test(text)) return {relevance:'ai_relevant',reason:'原文直接讨论模型、智能体或 AI 的具体使用、能力或影响。',evidence:[excerpt(text, hit)],method:'rules'};
