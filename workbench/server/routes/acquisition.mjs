...
import { acquisitionAction, cancelAcquisition, requestSourceFulltext } from '../acquisition/runner.mjs';
...
export const acquisitionRoutes=[
 ...
 route('POST','/api/workspace/acquisition/sources/:id/fulltext',(w,p,b)=>requestSourceFulltext(w,p.id,b)),
