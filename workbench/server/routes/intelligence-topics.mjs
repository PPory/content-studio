import {createIntelligenceTopicIntent,openLegacyIntelligenceTopic} from '../domain/intelligence-topic-intents.mjs';
...
export const intelligenceTopicRoutes=[
 route('POST','/topics/intents',(w,c,b)=>createIntelligenceTopicIntent(w,b)),
 route('POST','/topics/legacy/:kind/:id/open',(w,c,b)=>({research:openLegacyIntelligenceTopic(w,c.params.kind,c.params.id,b)})),
