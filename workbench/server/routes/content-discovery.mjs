import {directionKey,directionDetail,savedDirections,keepDirection,dismissDirection,developDirection,directionToContent} from '../domain/intelligence-directions.mjs';
...
export const contentDiscoveryRoutes = [
 ...
 {method:'POST',path:'/api/workspace/intelligence/directions/:id/content',handler:guard(async({workspace,res,params})=>json(res,{ok:true,...directionToContent(workspace,params.id)}))},
