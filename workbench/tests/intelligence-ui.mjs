...
try{
 ...
 await page.goto("http://127.0.0.1:5238/#/hot");await page.getByRole("heading",{name:"今日精选",exact:true}).waitFor();assert(!await page.getByRole("heading",{name:"热点",exact:true}).count());await page.goto("http://127.0.0.1:5238/#/intel-legacy");
