...
try{
 ...
 await page.setViewportSize({width:1440,height:1000});await page.locator(".intelligence").scrollIntoViewIfNeeded();await page.screenshot({path:path.join(shots,"intelligence-settings-desktop.png"),fullPage:true});
