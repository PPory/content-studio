...
try{
 ...
 await page.goto("http://127.0.0.1:5238/#/intel-legacy");await page.getByRole("tab",{name:"热点",exact:true}).click();assert(!await page.getByLabel("这次想了解什么？",{exact:true}).count(),"旧版选题发现已下线");
